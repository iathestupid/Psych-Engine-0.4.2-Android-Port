...
class MainMenuState extends MusicBeatState
{
    ...
    public static var sourceEngineVersion:String = '0.1.5'; //This is also used for Discord RPC
	...
	override function create()
	{
        ...
        var versionShit:FlxText = new FlxText(12, FlxG.height - 64, 0, "Source Engine v" + sourceEngineVersion, 12);
